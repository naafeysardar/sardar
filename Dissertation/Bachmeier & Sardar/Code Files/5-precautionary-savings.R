...
plot(gas.rec, type = "l", col = "black", xlab = "Quarters", ylab = "% Change", ylim= c(0, 20), main = "Gasoline Expenditures"); abline(h=0)
points(gas.exp, type = "l", col = "black", lty = 2)

gas.exp <- cumsum(gas.exp)
gas.rec <- cumsum(gas.rec)
...
plot(rpg.rec, type = "l", col = "black", xlab = "Quarters", ylab = "% Change", ylim= c(0, 20), main = "Real Price of Gas"); abline(h=0)
points(rpg.exp, type = "l", col = "black", lty = 2)
...
plot(residential.rec, type = "l", col = "black", xlab = "Quarters", ylab = "% Change", ylim= c(-2, 2), main = "Residential Consumption"); abline(h=0)
points(residential.exp, type = "l", col = "black", lty = 2)
...
plot(trans.rec, type = "l", col = "black", xlab = "Quarters", ylab = "% Change", ylim= c(-2, 2), main = "Transport Consumption"); abline(h=0)
points(trans.exp, type = "l", col = "black", lty = 2)
...
plot(miles.rec, type = "l", col = "black", xlab = "Quarters", ylab = "% Change", ylim= c(-2, 2), main = "Miles Travelled"); abline(h=0)
points(miles.exp, type = "l", col = "black", lty = 2)
