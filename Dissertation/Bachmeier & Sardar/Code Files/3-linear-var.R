...
varinfo <- list(
  ...
  list(public, "Public Transport"),
  list(motor.services, "Motor Services"),
  list(recreation, "Recreation Services"),
  list(food.services, "Food Services"),
  list(health, "Healthcare"),
  list(outpatient, "Outpatient Services"),
  list(hospital, "Hospital & Nursing Homes"),
